...
var knownFolderIDs = map[string][16]byte{
	...
	// FOLDERID_NetworkFolder = {D20BEEC4-1CA8-41C4-B0C8-6B4A9153F102}
	"NetworkFolder":    {0xC4, 0xEE, 0x0B, 0xD2, 0xA8, 0x1C, 0xC4, 0x41, 0xB0, 0xC8, 0x6B, 0x4A, 0x91, 0x53, 0xF1, 0x02},
	// FOLDERID_RecycleBinFolder = {B753F00B-93A5-4E26-8380-7A4C81B29A95}
	"RecycleBinFolder": {0x0B, 0xF0, 0x53, 0xB7, 0xA5, 0x93, 0x26, 0x4E, 0x83, 0x80, 0x7A, 0x4C, 0x81, 0xB2, 0x9A, 0x95},
}
